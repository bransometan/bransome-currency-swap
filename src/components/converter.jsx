...
function converterApp() {
    ...
    try {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          Swal.fire({
            title: "Cancelled",
            text: "You cancel the convert and your currencies are safe :)",
            icon: "error",
            confirmButtonColor: "#0275d8",
          });
        }
  ...
  return (
    <section className="border border-indigo-500/50 rounded-3xl pt-14 bg-white pb-14 px-6 shadow-2xl shadow-cyan-500/50">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mx-auto w-60 my-10">
          <label
            className="block text-gray-700 text-sm font-bold mb-2"
